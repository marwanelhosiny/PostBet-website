      ...
      <div className="container">
        ...
        <Accordion defaultIndex={[0]} allowToggle>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              {t(
                "Poswize provides smart tools for editing content before publishing, and the ability to upload and publish multiple files at once. Additionally, we offer AI technology that helps you create unique content based on your descriptions."
              )}
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              {t(
                "We aim to empower individuals and businesses to scale their digital presence with less effort and greater results. Poswize is your ideal partner for managing digital content in a smart and fast way."
              )}
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              {t(
                "From social media management platforms like Poswize to custom-built software and mobile apps, we offer a wide range of services designed to fuel digital transformation."
              )}
            </AccordionPanel>
          </AccordionItem>
        </Accordion>
